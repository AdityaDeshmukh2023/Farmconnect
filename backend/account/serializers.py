...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = [
            'name', 'contact', 'location', 'land_type', 'crops', 'livestock',
            'fertilizers', 'pesticides', 'irrigation', 'seed_brand', 'profile_picture',
            'followers_count', 'following_count', 'post_count','email'
        ]
...
class MinimalProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = Profile
        fields = [
            'name', 'contact', 'location', 'profile_picture'
        ]
...
class NestedProfileSerializer(serializers.ModelSerializer):
    ...
    def get_followers(self, obj):
        # Get the profiles of all followers
        followers_profiles = Profile.objects.filter(user__in=obj.followers.all())
        return MinimalProfileSerializer(followers_profiles, many=True).data

    def get_following(self, obj):
        # Get the profiles of all users being followed
        following_profiles = Profile.objects.filter(user__in=obj.following.all())
        return MinimalProfileSerializer(following_profiles, many=True).data
...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = [
            'id', 'user', 'username', 'profile_picture', 'description', 'photo', 'date',
